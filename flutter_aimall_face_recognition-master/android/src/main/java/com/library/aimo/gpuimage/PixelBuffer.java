...
public class PixelBuffer {
    ...
    public void setRenderer(final GLSurfaceView.Renderer renderer) {
        ...
        if (!Thread.currentThread().getName().equals(mThreadOwner)) {
            ImoLog.e(TAG, "setRenderer: This thread does not own the OpenGL context.");
            return;
        }
    ...
    public Bitmap getBitmap(Rect rect) {
        ...
        if (mRenderer == null) {
            ImoLog.e(TAG, "getBitmap: Renderer was not set.");
            return null;
        }

        // Does this thread own the OpenGL context?
        if (!Thread.currentThread().getName().equals(mThreadOwner)) {
            ImoLog.e(TAG, "getBitmap: This thread does not own the OpenGL context.");
            return null;
        }
...
//        L.i(TAG, "}");
    ...
    private void convertToBitmap(Rect rect) {
        ...
        mGL.glReadPixels(x, y, w, h, GL_RGBA, GL_UNSIGNED_BYTE, ib);
        int[] ia = ib.array();
