...
public class GPUImageGaussianBlurFilter extends GPUImageTwoPassTextureSamplingFilter {
    ...
    public GPUImageGaussianBlurFilter(float blurSize, String vertexShader) {
        super(vertexShader, FRAGMENT_SHADER, vertexShader, FRAGMENT_SHADER);
        mBlurSize = blurSize;
    }

    public GPUImageGaussianBlurFilter(float blurSize) {
        this(blurSize, VERTEX_SHADER);
    }
