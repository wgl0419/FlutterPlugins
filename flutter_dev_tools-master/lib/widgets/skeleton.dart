...
class Skeleton extends StatefulWidget {
  ...
  /// The animation type of the skeleton, default is [SkeletonAnimationType.shimmer].
  /// If you specify [SkeletonAnimationType.stretch] type, you must set [width] and [stretchWidth].
  final SkeletonAnimationType type;

  /// The 'animate to' width when choose [SkeletonAnimationType.stretch] type.
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          final Gradient? gradient = widget.type == SkeletonAnimationType.shimmer
              ? LinearGradient(
              ...
              : null;
          final double? width = widget.type == SkeletonAnimationType.shimmer ? widget.width : _animation.value;
          final decColor = widget.type == SkeletonAnimationType.stretch ? color : null;

          return Container(
            decoration:
                BoxDecoration(shape: shape, borderRadius: widget.borderRadius, color: decColor, gradient: gradient),
